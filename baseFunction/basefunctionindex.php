...
/**
 *	\file       htdocs/modulebuilder/template/basefunctionindex.php
 *	\ingroup    basefunction
 *	\brief      Home page of basefunction top menu
 */
...
$langs->loadLangs(array("basefunction@basefunction"));
...
if (! $user->rights->basefunction->read) accessforbidden();
...
llxHeader("", $langs->trans("BaseFunctionArea"));

print load_fiche_titre($langs->trans("BaseFunctionArea"), '', 'basefunction.png@basefunction');
...
// Draft MyObject
if (! empty($conf->basefunction->enabled) && $user->rights->basefunction->read)
{
	$langs->load("orders");
