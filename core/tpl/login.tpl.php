...
?>
	...
	<input id="securitycode" placeholder="<?php echo $langs->trans("SecurityCode"); ?>" class="flat input-icon-security width100" autocomplete="off" type="text" maxlength="5" name="code" tabindex="3" />
	</span>
	</td>
