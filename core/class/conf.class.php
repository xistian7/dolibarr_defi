	...
	public function setValues($db)
	{
		...
		foreach ($handlers as $handler) {
			...
			if (empty($this->loghandlers[$handler])) {
                ...
                //VASA desabilitar parts del projecte
                //$this->global->MAIN_DISABLE_CONTACTS_TAB = true;
                //$this->global->MAIN_DISABLE_NOTES_TAB = true;
                //$this->global->MAIN_DISABLE_FREE_LINES = true;
